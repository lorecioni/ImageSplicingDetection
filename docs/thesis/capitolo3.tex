...
In this round of experiment, we performed a cross-dataset validation in which we train our method with images from DSI-1 and test it against images from the DSO-1 dataset. We achieved an average classification accuracy of 63\%. 
...
In this round of experiment, we performed a cross-dataset validation in which we train our method with images from DSO-1 and test it against images from the Internet (DSI-1). We achieved an average classification accuracy of 59\%. 
