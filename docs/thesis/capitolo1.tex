...
\begin{figure}
  \centering
    \includegraphics[width=0.8\textwidth]{illuminant_maps}
...
\begin{figure}
  \centering
    \includegraphics[width=0.8\textwidth]{iic_space}
...
\begin{enumerate}
\item \emph{Description}: in this step illuminant maps are estimated with the two different approaches, GGE and IIC.
\end{enumerate}
