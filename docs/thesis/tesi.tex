...
\Title{Illuminant map analysis for image splicing detection}%  
\Author{Lorenzo Cioni}% *not* set by LaTeX's \author
\Subject{Illuminant map analysis for image splicing detection}
\Keywords{Illuminant map,splicing detection, image forensics} 
...
\begin{flushright}
\textit{{\large A Agnese ed alla mia famiglia}}
\end{flushright}
}
