...
\hypersetup{ 
  ...
  pdfsubject=Image splicing detection with local illuminant estimation
}    
...
\advisor{Prof. Carlo Colombo} %correlatore
\advisor{Dott. Massimo Iuliani} %correlatore
\advisor{Dott. Marco Fanfani} %correlatore
\author{Lorenzo Cioni}

%titolo in italiano
\title{\textbf{{\Huge Image splicing detection with local illuminant estimation}}}
