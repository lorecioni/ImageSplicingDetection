...
\vspace{0.3cm}
\only<4>{
\textit{Main advantage}: being fairly independent on low-level characteristics of images, they are extremely robust to compression, altering, and other image processing operations
}
\end{tframe}
...
\only<1->{
\begin{enumerate}
\item<2-> \textbf{Object light source inconsistencies}
\vspace{0.1cm}
\item<3-> \textbf{\uline{Illuminant colors inconsistencies}}
\vspace{0.1cm}
\begin{enumerate}
\item<4-> \textit{Specular dichromatic reflectance models} {\tiny (Gholap and Bora, 2008 [5])}
\vspace{0.1cm}
\item<4> \textbf{\uline{Illuminant Maps (IMs)}}
\end{enumerate}
\end{enumerate}
}
\vspace{0.3cm}
...
\vspace{-1cm}
\begin{center}
\textbf{Main goal}: \emph{starting from two different approaches, remove the Human from the Loop and introducing some improvements}
\end{center}
}
\uncover<3->{
\vspace{0.1cm}
...
\includegraphics[width=1.15\textwidth]{images/pipeline_faces_1.jpg}
\end{adjustwidth}
\end{center}
...
\vspace{-.5cm}
\begin{adjustwidth}{-1cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_faces_2.jpg}
\end{adjustwidth}
\end{center}
}
\only<3>{
...
\vspace{-.5cm}
\begin{adjustwidth}{-1cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_faces_3_stroke.jpg}
\end{adjustwidth}
\end{center}
}
\only<4>{
...
\vspace{-.5cm}
\begin{adjustwidth}{-1cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_faces_4.jpg}
\end{adjustwidth}
\end{center}
}
\only<5>{
...
\vspace{-.5cm}
\begin{adjustwidth}{-1cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_faces_5.jpg}
\end{adjustwidth}
\end{center}
}
\only<6->{
...
\vspace{-.5cm}
\begin{adjustwidth}{-1cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_faces_6.jpg}
\end{adjustwidth}
\end{center}
}
\only<7>{
...
\includegraphics[width=1.15\textwidth]{images/pipeline_regions_1.jpg}
\end{adjustwidth}
\end{center}
}
\only<2>{
...
\vspace{-0.7cm}
\begin{adjustwidth}{-0.85cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_regions_2.jpg}
\end{adjustwidth}
\end{center}
}
\only<3>{
...
\vspace{-0.7cm}
\begin{adjustwidth}{-0.85cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_regions_3.jpg}
\end{adjustwidth}
\end{center}
}
\only<4>{
...
\vspace{-0.7cm}
\begin{adjustwidth}{-0.85cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_regions_4.jpg}
\end{adjustwidth}
\end{center}
}
\only<5->{
...
\vspace{-0.7cm}
\begin{adjustwidth}{-0.85cm}{} 
\includegraphics[width=1.15\textwidth]{images/pipeline_regions_5.jpg}
\end{adjustwidth}
\end{center}
}
\vspace{-0.5cm}
...
\begin{footnotesize}
$$
\textrm{GGE estimation} \qquad k\textbf{e}^{n, p, \sigma} = (\int |\frac{\vartheta^{n}\textbf{f}^{\sigma}(\textbf{x})}{\vartheta\textbf{x}^{n}}|^{p}  d\textbf{x})^{\frac{1}{p}}
$$
\end{footnotesize}
%
...
\begin{footnotesize}
\vspace{0.2cm}
Two different \textbf{reference colors} are considered:
\vspace{0.5cm}
\begin{itemize}
...
\minipage{0.5\textwidth}
\centering
  \includegraphics[width=0.65\linewidth]{images/splicedcchor}
\endminipage\hfill
\minipage{0.5\textwidth}
\centering
  \includegraphics[width=0.6\linewidth]{images/spliceddsover}
\endminipage
\end{figure}
}
\only<3>{
