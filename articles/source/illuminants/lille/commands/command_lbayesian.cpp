...
CommandLocalBayesian::CommandLocalBayesian():
	Command("lbayesian",
		config,
		"Tiago Carvalho",
		"tiagojc@gmail.com"
...
int CommandLocalBayesian::execute()
{
	...
	illumestimators::BayesianEstimator est(config.n, config.p, config.sigma);
...
void CommandLocalBayesian::printShortHelp() const
{
	std::cout << "Locally applied illuminant estimator, using the generalized Bayesian algorithm." << std::endl;
}

void CommandLocalBayesian::printHelp() const
{
	std::cout << "Locally applied illuminant estimator, using the generalized Bayesian algorithm." << std::endl;
}
