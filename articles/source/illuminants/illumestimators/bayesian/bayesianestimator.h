#ifndef ILLUMESTIMATORS_BAYESIAN_BAYESIANESTIMATOR_H
#define ILLUMESTIMATORS_BAYESIAN_BAYESIANESTIMATOR_H
 ...
 */
class BayesianEstimator : public IlluminantEstimator
{
public:
	 ...
	 */
	BayesianEstimator(int n = 0, int p = 1, double sigma = 0);
	~BayesianEstimator();
