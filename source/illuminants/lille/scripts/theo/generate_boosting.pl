...
my $input = '/net/cv/illum/gijsenij_liu/img/';
my $output = '/disks/data1/riess/mimorem/table_theo/diffuse/boosting/wrong/';
my $trained_tree = '/disks/data1/riess/mimorem/trained_boosting_tree_gw_variants_shi_gehler.dat'; 

my $seg_dir  = '/net/cv/illum/gijsenij_liu/seg_50_10/';
my $mask_dir = '/net/cv/illum/gijsenij_liu/mask/';

my $bin = '/disks/data1/riess/code/build/bin/vole lboosting';
