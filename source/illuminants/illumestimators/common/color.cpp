...
Illum Color::calculateChromaticities(Illum color)
{
	...
	return Illum(color.r / sum, color.g / sum, color.b / sum);
}


cv::Vec3d Color::calculateChromaticities(cv::Vec3d color)
{
...
cv::Mat_<cv::Vec3d> Color::colorCorrectImage(const cv::Mat_<cv::Vec3d>& image, const cv::Vec3d& estimate)
{
...
cv::Mat_<cv::Vec3d> Color::srgb2bgr(const unsigned char* input, int rows, int cols)
{
...
cv::Mat_<cv::Vec3d> Color::rgb2bgr(const unsigned char* input, int rows, int cols)
{
	cv::Mat_<cv::Vec3d> output = cv::Mat_<cv::Vec3d>(rows, cols);
...
cv::Mat_<cv::Vec3d> Color::sbgr2bgr(const cv::Mat_<cv::Vec3b>& input)
{
...
cv::Mat_<cv::Vec3d> Color::bgr2bgr(const cv::Mat_<cv::Vec3b>& input)
{
	cv::Mat_<cv::Vec3d> output = cv::Mat_<cv::Vec3d>(input.rows, input.cols);
...
cv::Vec3d Color::rgb2bgr(const cv::Vec3d& input)
{
	cv::Vec3d output;
...
cv::Vec3d Color::bgr2rgb(const cv::Vec3d& input)
{
	cv::Vec3d output;
...
cv::Mat_<cv::Vec3d> Color::sbgr2bgr(const cv::Mat_<cv::Vec3d>& input)
{
...
cv::Mat_<cv::Vec3d> Color::bgr2sbgr(const cv::Mat_<cv::Vec3d>& input)
{
	cv::Mat_<cv::Vec3d> output(input.rows, input.cols);
